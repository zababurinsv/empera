...
global.DB_CHAIN_FORMAT = {BlockNum:"uint", StartVersion:"uint32", ArrBlock:[{BlockNum:"uint", LinkSumHash:"hash", PrevSumHash:"hash",
        TreeHash:"hash", MinerHash:"hash", SumPow:"uint", TxData:[{HASH:"hash", HashPow:"hash", body:"tr"}], BodyLinkVer:"uint", FirstEmptyBodyNum:"uint",
        FirstEmptyBodyHash:"hash", HeadNum:"uint", HeadRow:"uint16", HeadDeltaSum:"uint", VersionDB:"byte", StartVersion:"uint32",
    }]};
