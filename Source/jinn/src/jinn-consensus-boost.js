...
function InitClass(Engine)
{
    ...
    Engine.StartSendMaxHash = function (BlockNum) {
        console.log('CONSENSUS BOOST [(StartSendMaxHash)]', {
            BlockNum: BlockNum
        })
    ...
    Engine.GetMaxArrForSend = function (Context,Child,BlockNum,bNextSend) {
        console.log('CONSENSUS BOOST [(GetMaxArrForSend)]', {
            Context:Context,
            Child: Child,
            BlockNum: BlockNum,
            bNextSend: bNextSend
    ...
    Engine.SendMaxHashToOneNode = function (Context,BlockNum,Child,IterationNum,bNext) {
        console.log('CONSENSUS BOOST [(SendMaxHashToOneNode)]', {
            Context: Context,
            BlockNum: BlockNum,
            Child: Child,
    ...
    Engine.MAXHASH = function (Child,Data) {
        console.log('CONSENSUS BOOST [(MAXHASH)]', {
            Child: Child,
            Data: Data
        })
    ...
    Engine.DoMaxHash = function (Child,Data) {
        console.log('CONSENSUS BOOST [(DoMaxHash)]', {
            Child: Child,
            Data: Data
        })
    ...
    Engine.SendMaxHashNextTime = function (Context,BlockNum,Child,IterationNum,bNext) {
        console.log('CONSENSUS BOOST [(SendMaxHashNextTime)]', {
            Context: Context,
            BlockNum: BlockNum,
            Child: Child,
            IterationNum: IterationNum,
    ...
    Engine.CheckPacketSize = function (BlockNum,BlockNumLoad,Size) {
        console.log('CONSENSUS BOOST [(CheckPacketSize)]', {
            BlockNum: BlockNum,
            BlockNumLoad: BlockNumLoad,
            Size: Size
        })
    ...
    Engine.GetHeaderArrForChild = function (BlockNum,Status,Child) {
        console.log('CONSENSUS BOOST [(GetHeaderArrForChild)]', {
            BlockNum: BlockNum,
            Status: Status,
            Child: Child
        })
    ...
    Engine.AddHeaderBlockToArr = function (Child,Arr,BlockHeader,Size,BlockNum) {
        console.log('CONSENSUS BOOST [(AddHeaderBlockToArr)]', {
            Child:Child,
            Arr: Arr,
    ...
    Engine.CheckProcessTime = function (Child) {
        console.log('CONSENSUS BOOST [(CheckProcessTime)]', {
            Child: Child
        })
    ...
    Engine.GetBodyArrForChild = function (Child,BlockNum,LoadNum,LoadHash,CountItem,bFirstBody) {
        console.log('CONSENSUS BOOST [(GetBodyArrForChild)]', {
            Child: Child,
            BlockNum: BlockNum,
            LoadNum: LoadNum,
            LoadHash: LoadHash,
            CountItem: CountItem,
            bFirstBody: bFirstBody
        })
        var Size = 0;
        var ArrRet = [];
    ...
    Engine.AddBodyBlockToArr = function (Child,Arr,BlockBody,Size,BlockNum) {
        console.log('CONSENSUS BOOST [(AddBodyBlockToArr)]', {
            Child: Child,
            Arr: Arr,
            BlockBody: BlockBody,
            Size: Size,
