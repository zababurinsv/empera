...
const FORMAT_NET_CONSTANT = {NetConstVer:"uint", NetConstStartNum:"uint", PROTOCOL_MODE:"uint", MAX_TRANSACTION_COUNT:"uint16",
    ...
    MAX_ERR_PROCESS_COUNT:"uint", MAX_LEVEL_CONNECTION:"byte", EXTRA_SLOTS_COUNT:"byte", EXTRA_SLOTS_START_TIME:"uint32", MAX_LEVEL_NODES:"byte",
    MAX_RET_NODE_LIST:"uint16", MAX_CACHE_BODY_LENGTH:"uint32", MAX_DEPTH_FOR_SECONDARY_CHAIN:"uint32", MAX_DELTA_PROCESSING:"byte",
    METHOD_ALIVE_TIME:"uint32", STEP_ADDTX:"byte", STEP_TICKET:"byte", STEP_TX:"byte", STEP_MINING:"byte", STEP_MAXHASH:"byte",
