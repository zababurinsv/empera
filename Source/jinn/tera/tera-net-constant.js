...
const FORMAT_NET_CONSTANT = {NetConstVer:"uint", NetConstStartNum:"uint", PROTOCOL_MODE:"uint", MAX_TRANSACTION_COUNT:"uint16",
    MIN_COUNT_FOR_CORRECT_TIME:"uint", CORRECT_TIME_TRIGGER:"uint16", CORRECT_TIME_VALUE:"uint16", MAX_LEADER_COUNT:"byte", MAX_ITEMS_FOR_LOAD:"uint32",
    ...
    EXTRA_SLOTS_START_TIME:"uint32", MAX_LEVEL_NODES:"byte", MAX_RET_NODE_LIST:"uint16", HOT_CACHE_DELTA:"uint32", CACHE_DB_LENGTH:"uint32",
    MAX_CACHE_BODY_LENGTH:"uint32", MAX_DEPTH_FOR_SECONDARY_CHAIN:"uint32", MAX_DELTA_PROCESSING:"byte", STEP_ADDTX:"byte", STEP_TICKET:"byte",
    STEP_TX:"byte", STEP_MINING:"byte", STEP_MAXHASH:"byte", STEP_LAST:"byte", STEP_CLEAR_MEM:"byte", CORRECT_TIME_RUN:"byte",
    CORRECT_TIME_START_NUM:"uint", CORRECT_TIME_END_NUM:"uint", CORRECT_TIME_ADD_MODE:"byte", CORRECT_TIME_DELTA:"uint", UNIQUE_IP_MODE:"uint16",
    CHECK_POINT_NUM:"uint", CHECK_POINT_HASH:"hash", RESERVE_DATA:"arr410", NET_SIGN:"arr64"};
