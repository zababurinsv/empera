...
global.UPDATE_CODE_VERSION_NUM = 1650;
global.MIN_JINN_VERSION_NUM = 1648;
...
global.CONST_NAME_ARR = ["DELTA_CURRENT_TIME", "JINN_AUTO_CORRECT_TIME", "WALLET_NAME", "WALLET_DESCRIPTION", "COMMON_KEY",
"NODES_NAME", "SERVER_PRIVATE_KEY_HEX", "USE_NET_FOR_SERVER_ADDRES", "NET_WORK_MODE", "STAT_MODE", "MAX_STAT_PERIOD", "LISTEN_IP",
"HTTP_PORT_NUMBER", "HTTP_PORT_PASSWORD", "HTTP_IP_CONNECT", "USE_API_WALLET", "USE_API_V1", "USE_HARD_API_V2", "MAX_TX_FROM_WEB_IP",
"COUNT_VIEW_ROWS", "ALL_VIEW_ROWS", "ALL_LOG_TO_CLIENT", "LOG_LEVEL", "START_HISTORY", "USE_MINING", "MINING_START_TIME", "MINING_PERIOD_TIME",
"POW_MAX_PERCENT", "COUNT_MINING_CPU", "SIZE_MINING_MEMORY", "POW_RUN_COUNT", "USE_AUTO_UPDATE", "RESTART_PERIOD_SEC", "MAX_GRAY_CONNECTIONS_TO_SERVER",
...
"UNIQUE_IP_MODE", "REST_START_COUNT", "LOAD_TO_BEGIN", "MAX_SIZE_DB", ];
...
global.MAX_PACKET_LENGTH = 570 * 1024;
...
if(global.JINN_MODE)
{
    ...
    global.START_BAD_ACCOUNT_CONTROL = 495000;
